...
export const assetManifest: readonly AssetAttribution[] = [
  {
    id: "handaxe-photo",
    localPath: "/assets/artifacts/generated/handaxe-learning-reconstruction.png",
    imageSource: "ai-generated-learning-reconstruction",
    originalFileName: "handaxe-learning-reconstruction.png",
    institution: "국립중앙박물관",
    artifactTitle: "주먹도끼",
    collectionNumber: "신수18710",
    licenseType: "KOGL-1",
    licenseUrl: "https://www.kogl.or.kr/info/licenseType1.do",
    requiredCredit: "AI 생성 학습용 재구성 이미지 · 참고 기록: 국립중앙박물관 주먹도끼(신수18710)",
    ...
    originalSha256: "73dc4ec7c5ab87590b1a5c66153c477319d11f12def5ba07e2ece0018daefb2f",
    derivativeSha256: "73dc4ec7c5ab87590b1a5c66153c477319d11f12def5ba07e2ece0018daefb2f",
    derivativeOperations: ["이미지 생성 모델로 학습용 재구성 이미지를 생성; 글자·로고·워터마크 없이 한 물체 중심으로 제작."],
  },
  {
    id: "figurine-lid-photo",
    localPath: "/assets/artifacts/generated/figurine-lid-learning-reconstruction.png",
    imageSource: "ai-generated-learning-reconstruction",
    originalFileName: "figurine-lid-learning-reconstruction.png",
    institution: "국립경주박물관",
    artifactTitle: "토우장식 뚜껑",
    collectionNumber: "경주5772",
    licenseType: "KOGL-1",
    licenseUrl: "https://www.kogl.or.kr/info/licenseType1.do",
    requiredCredit: "AI 생성 학습용 재구성 이미지 · 참고 기록: 국립경주박물관 토우장식 뚜껑(경주5772)",
    ...
    checkedAt: "2026-07-17",
    originalSha256: "d9b0ac8537bb24d82e5ebe0ad16c5b5991a044f4eb3581d31b112c4bed5159f8",
    derivativeSha256: "d9b0ac8537bb24d82e5ebe0ad16c5b5991a044f4eb3581d31b112c4bed5159f8",
    derivativeOperations: ["이미지 생성 모델로 학습용 재구성 이미지를 생성; 둥근 뚜껑과 뱀·개구리 장식의 관찰 특징을 유지."],
  },
  {
    id: "celadon-die-photo",
    localPath: "/assets/artifacts/generated/celadon-die-learning-reconstruction.png",
    imageSource: "ai-generated-learning-reconstruction",
    originalFileName: "celadon-die-learning-reconstruction.png",
    institution: "국립중앙박물관",
    artifactTitle: "청자 상감 주사위",
    collectionNumber: "덕수6421",
    licenseType: "KOGL-1",
    licenseUrl: "https://www.kogl.or.kr/info/licenseType1.do",
    requiredCredit: "AI 생성 학습용 재구성 이미지 · 참고 기록: 국립중앙박물관 청자 상감 주사위(덕수6421)",
    ...
    checkedAt: "2026-07-17",
    originalSha256: "87e402db4501b05a691520d8f5b4b6c1cc32d184db6140ff20117461dd53bc84",
    derivativeSha256: "87e402db4501b05a691520d8f5b4b6c1cc32d184db6140ff20117461dd53bc84",
    derivativeOperations: ["이미지 생성 모델로 학습용 재구성 이미지를 생성; 청자빛 정육면체와 여러 면의 점 표시를 유지."],
  },
];
...
export const caseBank: readonly CaseFile[] = [
  {
    ...
    clues: [
      ...
      { id: "handaxe-catalog", stage: 2, status: "documented", title: "박물관 기록", text: "박물관은 이 유물을 구석기의 화강암 물건으로, 길이 16.5cm이며 연천군 땅에서 나왔다고 기록해요. 땅에서 나온 곳을 출토지라고 해요.", sourceUrl: assetManifest[0].recordUrl },
    ...
    hypotheses: [
      ...
      { id: "defer", text: "사진만 보고는 아직 정하기 어렵다.", supportByStage: { 1: "responsible-defer", 2: "responsible-defer", 3: "responsible-defer" }, scopeLimit: "아직 결정하지 않기(판단 보류)도 자료를 더 살피는 방법이에요." },
    ],
  ...
  },
  {
    ...
    question: "뚜껑 위 그림을 보고, 사진에서 바로 보이는 것과 아직 모르는 것을 나누어 보세요.",
    ...
    clues: [
      ...
      { id: "lid-catalog", stage: 2, status: "documented", title: "박물관 기록", text: "박물관은 이 뚜껑을 신라 4~6세기 경주 월성로 무덤군에서 나온 것으로 기록해요.", sourceUrl: assetManifest[1].recordUrl },
      { id: "lid-context", stage: 3, status: "inferred", title: "다른 자료와 생각해 보기", text: "개구리가 자라며 모습이 바뀌는 일(변태)과 뱀이 허물을 벗는 모습(탈피)을 떠올리며, 박물관은 당시 사람이 다시 이어지기를 바랐을 가능성을 설명해요.", sourceUrl: assetManifest[1].recordUrl },
    ...
    hypotheses: [
      ...
      { id: "renewal", text: "무덤에 넣으며 다시 이어지기를 바라는 뜻을 담았을 것이다.", supportByStage: { 1: "plausible-limited", 2: "plausible-limited", 3: "best-supported" }, scopeLimit: "이는 박물관이 제시한 가능성이며 만든 사람의 직접 말은 아니에요." },
  ...
  },
  {
    ...
    question: "작은 네모 물건의 점과 박물관 기록을 함께 보고, 어디까지 말할 수 있는지 정해 보세요.",
    ...
    clues: [
      ...
      { id: "die-catalog", stage: 2, status: "documented", title: "박물관 기록", text: "박물관은 고려의 상감청자, 약 1.2cm 크기이며 놀이할 때 쓰는 주사위로 분류해요.", sourceUrl: assetManifest[2].recordUrl },
      { id: "die-context", stage: 3, status: "inferred", title: "다른 자료와 생각해 보기", text: "사실: 14세기 후반 교역선에서도 주사위가 바다에서 건져 올려졌다는 기록이 있어요. 생각: 이 비교는 놀이에서 나온 숫자로 순서나 결과를 정했을 가능성을 살피게 해요.", sourceUrl: assetManifest[2].recordUrl },
      { id: "die-unknown", stage: 3, status: "unknown", title: "남은 빈칸", text: "이 물건이 땅에서 나온 곳(출토지), 정확한 놀이 규칙, 사용자는 알 수 없어요.", sourceUrl: assetManifest[2].recordUrl },
    ],
    hypotheses: [
      { id: "play", text: "놀이에서 나온 숫자로 순서나 결과를 정하는 주사위였을 것이다.", supportByStage: { 1: "plausible-limited", 2: "best-supported", 3: "best-supported" }, scopeLimit: "어떤 놀이였는지나 사용자를 정할 수는 없어요." },
    ...
    unknownText: "땅에서 나온 곳(출토지), 정확한 놀이 규칙, 사용자는 현재 자료로 알 수 없어요.",
